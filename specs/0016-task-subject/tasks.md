...
- [x] **Persist the task subject** (test-type: integration)
  - blocked-by: none
...
- [x] **Resolve subject options per kind** (test-type: unit)
  ...
  - verification: `./gradlew test`
- [x] **Validate the subject and prefill the title** (test-type: unit)
  ...
  - verification: `./gradlew test`
- [x] **Choose the subject in the task form** (test-type: both)
  ...
  - verification: `./gradlew test`
- [x] **Suggest medicines already used** (test-type: both)
  ...
  - verification: `./gradlew test`
- [x] **Show the subject where the task appears** (test-type: both)
  - blocked-by: choose the subject in the task form
  ...
  - verification: `./gradlew test`
- [x] **Carry the subject through export, import, and sharing** (test-type: both)
  - blocked-by: persist the task subject
