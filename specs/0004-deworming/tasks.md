...
- [x] **Calculate and display per-record status** (test-type: both)
  ...
  - verification: `./gradlew test`
- [x] **Separate health status by category** (test-type: both)
  ...
  - verification: `./gradlew test`
- [x] **Add automated deworming regression tests** (test-type: both)
